    ...
    public class ParameterSet : IParameterSet
    {
        ...
        */
        ...
        private void SetParameters(Dictionary<string, double> parameters)
        {
            ...
            MethodInfo info = typeof(ParameterSet).GetMethod(invokeString, BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        private void distanceOfTravel_maxVelocity_peakAcceleration_converter(double[] valuesn)
        {
