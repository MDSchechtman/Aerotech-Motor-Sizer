...
namespace Program
{
    public class ProjectScene
    {
        ...
        private void Initialize()
        {
            ...
            _panel.Controls.Add(_label1, 1, 3);
            _panel.Controls.Add(_label2, 1, 4);
            _panel.Controls.Add(_label3, 1, 5);
            _panel.Controls.Add(_label4, 1, 6);
            _panel.Controls.Add(_label5, 1, 7);


            _panel.Controls.Add(_textBox1, 2, 3);
            _panel.Controls.Add(_textBox2, 2, 4);
            _panel.Controls.Add(_textBox3, 2, 5);
            _panel.Controls.Add(_textBox4, 2, 6);
            _panel.Controls.Add(_textBox5, 2, 7);
